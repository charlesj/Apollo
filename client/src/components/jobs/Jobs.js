  ...
  render() {
    ...
    return (<div>
        ...
        return (<tr key={job.id}>
              ...
              <td><button className="pt-button pt-small pt-intent-success" onClick={this.setHistoryJob.bind(null, job)}>history</button> 
              <button className="pt-button pt-small pt-intent-danger" onClick={this.cancelJob.bind(null, job)}>cancel</button>
          </td>
          </tr>)
      })}
    </tbody></table>
