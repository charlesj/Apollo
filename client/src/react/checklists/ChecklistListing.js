...
function CheckListListingDisplay(props) {
  return (
    <div className="checklistListingDisplay">
...
class ChecklistListing extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="checklistListing">
        <input
          id="name"
          placeholder="name"
        ...
        <button className="textButton" onClick={this.toggleMode}>
          Cancel
        </button>
      </div>
    );
