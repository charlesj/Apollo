...
var strategies = [
  ...
  "Your mistake was a hidden intent"
];

class ObliqueStrategies extends React.Component {
  constructor(props) {
    super(props);
  ...
  getRandomStrategy() {
    this.setState({
      selected: strategies[Math.floor(Math.random() * strategies.length)]
    });
  }

  render() {
    return (
      <div className="obliqueStrategies">
        <div className="strategyTitle">
          Oblique Strategies{" "}
          <TextButton onClick={this.getRandomStrategy}>
        ...
        <div className="strategyDescription">
          ...
          {this.state.selected.length === 0 && (
            <span>Click refresh to get a strategy</span>
          )}
        </div>
      </div>
    );
